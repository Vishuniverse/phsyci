...
function setup(){
    ...
    block3=Bodies.rectangle(400,400,150,20,plane_options);
    World.add(world,block2);
    ...
    // World.add(world,rotator1);
     ...
     rotator1 = Bodies.rectangle(260,200,150,20,rotator_options);
     World.add(world,rotator1);

    rotator2 = Bodies.rectangle(250,200,150,20,rotator_options);
    World.add(world,rotator2);

    rotator3 = Bodies.rectangle(210,200,150,20,rotator_options);
...
function draw(){
  ...
  ellipse(particle4.position.x,particle4.position.y,60);
